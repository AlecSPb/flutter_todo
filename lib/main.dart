  ...
  Widget build(BuildContext context) {
    var app = MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          headline: TextStyle(fontSize: 28.0, fontWeight: FontWeight.w100),
          title: TextStyle(fontSize: 28.0, fontWeight: FontWeight.w100),
          body1: TextStyle(
            fontSize: 14.0,
            fontFamily: 'Hind',
          ),
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              child: Text('${DateTimeUtils.currentDate} ${DateTimeUtils.currentWeek}',
                            ...
                            Text(
                              '你有 ${_todos.where((todo) => todo.isCompleted == 0).length} 项任务要完成哦。',
